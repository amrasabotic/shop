    ...
    if(isset($_GET['delete'])){
        ...
        if(isset($_GET['deleteconfirm'])){
            ...
            if (confirm('Are you sure you want to delete this record?')) {
                window.location.href = 'deleteUser.php?delete=" . $userid . "&deleteconfirm=1';
            } else {
...
$sql_records = "SELECT userID, name, surname, levelName, username, password
				FROM user INNER JOIN accesslevel
				ON user.accessLevel=accesslevel.levelID";
...
<table>
	...
	<?php while($row = mysqli_fetch_array($result_records)) { ?>
	<tr>
    ...
    <!--- Footer --->
    <div class="my-5" style="position: relative; bottom: 0px; right: 0; left:0">
