...
while($row = mysqli_fetch_array($result)) {
    ...
    echo "<td>" . $colorID . "</td>";
    echo "<td>" . $color . "</td>";
    echo "<td><form method='post' action='editColor.php' style='all:initial;'>";
...
if (isset($_POST['colorID'])) {
    ...
    $sql3 = "SELECT * FROM color WHERE colorID = '$colorID';";
    $result3 = $conn->query($sql3);
    $row3 = mysqli_fetch_array($result3);
    
    $color = $row3['color'];
    
    echo "<form method='post' action='editColor.php'>";
    echo "<h3>Edit Color</h3>";
    echo "<input type='hidden' name='colorID' value='$colorID'>" ;
    echo "<label>Color:</label><input type='text' name='color' value='$color'>";
...
if (isset($_POST['color'])) {
    ...
    $sql6 = "SELECT DISTINCT colorID FROM color WHERE color = '$color';";
    $result6 = $conn->query($sql6);
    $row6 = mysqli_fetch_array($result6);
    
    $sql7 = "UPDATE color SET color = '$color' WHERE colorID = '$colorID';";
    $result7 = $conn->query($sql7);
    echo "<script>window.location.href = 'editColor.php';</script>";
}
?>
